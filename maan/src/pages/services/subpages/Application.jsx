...
import { AppDevelopmentList } from "../../../static/AppDevelopmentList";
  ...
  return (
    <>
      <Helmet>
        <meta
          name="keywords"
          content="Custom Mobile App Development Services, Web App Development Services"
        ></meta>
        <title>
          Best Custom Mobile App Development Services in USA | Web App
          Development Services | Maanz AI
        </title>
        <meta
          name="description"
          content="Maanz AI offers best custom mobile app development services and web app development services. We offers iOS app development services, android app development services."
        ></meta>
      </Helmet>
      ...
      <section className="ai-services-bg">
        <div className="container">
          {AppDevelopmentList.map((service, index) => (
