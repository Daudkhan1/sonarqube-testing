...
import { EmbeddedList } from "../../../static/EmbeddedList";
  ...
  return (
    <>
      <Helmet>
        <meta
          name="keywords"
          content="Embedded System Services, Embedded system development services"
        ></meta>
        <title>
          Best Embedded System Services in USA | Embedded System Consulting
          Services
        </title>
        <meta
          name="description"
          content="Accelerate your digital transformation with embedded system services that deliver Autosar Embedded services, IOT Integration services, RTOS Embedded System Services."
        ></meta>
      </Helmet>
      ...
      <section className="ai-services-bg">
        <div className="container">
          {EmbeddedList.map((service, index) => (
