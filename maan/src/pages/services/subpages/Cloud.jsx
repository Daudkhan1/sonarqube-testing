...
import { CloudList } from "../../../static/CloudList";
  ...
  return (
    <>
      <Helmet>
        <meta
          name="keywords"
          content="Best Cloud Storage Services, cloud computing services"
        ></meta>
        <title>
          Best Cloud Storage Services in USA | Best Cloud Computing Services |
          Best Cloud Storage for Business | Maanz AI
        </title>
        <meta
          name="description"
          content="Maanz AI provides you the best cloud storage services. We offers Amazon web services, Microsoft Azure, Google Cloud Platform and devOps services."
        ></meta>
      </Helmet>
